...
import org.atlanmod.commons.tester.RemoteTesterImpl;
...
public class MiddleTester {
    ...
    /**
     * Remaining commons registrations.
     */
    ...
    /**
     * Thread used to run this commons.
     */
    private Thread testerThread;
    /**
     * Thread used to quit this commons.
     */
    ...
    /**
     * Accessor to the commons interface
    ...
    /**
     * Registers methods with parent commons. The registerd methods is a Set,
    ...
    /**
     * Starts the thread for this commons
     */
    ...
    private class QuitThread implements Runnable {
        ...
        public void run() {
            ...
            // Then, interrupts the commons Thread.
