...
import org.atlanmod.commons.base.ResultListenner;
...
public class CoordinatorImpl implements Runnable {
    ...
    /*
     * List of commons for each order.
     */
     ...
     * Waits (blocks) until all commons have executed the action.
     * @param testers
     * @param md
     * @throws InterruptedException
     */
    public void execute(MethodDescription md) throws InterruptedException {
        ...
        for (Tester each : testers) {
            //LOG.finest("Dispatching " + md + " to commons " + each);
     ...
     * Waits until all commons have executed the actions.
     *
     * @param level
     * @throws InterruptedException
     */
    ...
    /**
     * Dispatches the actions of a given hierarchical level(order) verifying their dependencies
     * Waits until all necessary commons have executed the actions.
     *
     * @param level
     * @throws InterruptedException
     */
    ...
    public void waitForTesterRegistration() throws InterruptedException {
        ...
        while (registeredTesters.size() < expectedTesters.intValue()) {
            ...
            LOG.log(Level.FINEST, "Total commons registrations: {0}", registeredTesters.size());
        }
