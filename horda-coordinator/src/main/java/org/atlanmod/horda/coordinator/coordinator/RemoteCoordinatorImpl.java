...
public class RemoteCoordinatorImpl implements Coordinator, Serializable {
    ...
    /**
     * Counter used to increment commons identifications.
     */
...
//            throws RemoteException {
//        LOG.finest(String.format("%s registering commons %s", this, t));
...
//    }
    ...
    /**
     * Informs the coordinator that a commons is leaving the system.
     * 
     * @param t The commons.
     * @throws RemoteException
     */
     ...
     * Registers a commons.
     * @param t
     * @return An int, the ID for the registering commons.
     * @throws RemoteException
     */
