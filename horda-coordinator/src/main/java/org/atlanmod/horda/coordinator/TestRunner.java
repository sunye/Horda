 ...
 */
package org.atlanmod.horda.coordinator;

import org.atlanmod.horda.coordinator.distributed.DistributedTesterImpl;
import org.atlanmod.commons.remote.*;
import org.atlanmod.commons.tester.TesterImpl;
import org.atlanmod.commons.util.LogFormat;
...
public class TestRunner {
    ...
    /**
     * Launch the right implementation of <i>commons</i> passing it as argument the <tt>Class</tt>
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 1) {
            ...
            try {
                ...
                } else if (new File("Horda.properties").exists()) {
                    filename = "Horda.properties";
                    FileInputStream fs = new FileInputStream(filename);
                    defaults = new TesterUtil(fs);
                } else {
