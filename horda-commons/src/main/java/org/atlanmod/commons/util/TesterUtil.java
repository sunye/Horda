...
public class TesterUtil {
    ...
    private TesterUtil() {
        try {
            ...
            InputStream is = this.getClass().getResourceAsStream("/Horda.properties");
            defaults.load(is);
            is.close();
            props = new Properties(defaults);
            if (new File("Horda.properties").exists()) {
                String filename = "Horda.properties";
    ...
    private int readProperty() {
        try {
            peerName = Integer.valueOf(this.getProperty("commons.peers")).intValue();

        } catch (Exception e) {
            System.out.println("Property error: commons.peers");
        }
        return peerName;
    }
    ...
    public int getExpectedTesters() {
        return Integer.valueOf(this.getProperty("commons.peers")).intValue();
    }
    ...
    public String getServerAddr() {
        String address;
        address = this.getProperty("commons.server");
        if (address == null) {
            try {
                address = InetAddress.getLocalHost().getHostAddress();
            } catch (UnknownHostException e) {
                // TODO Auto-generated catch block
                System.out.println("Property error: commons.server");
            }
        }
    ...
    public String getLogfile() {
        return this.getProperty("commons.logfile");
    }
    ...
    public String getDateformat() {
        return this.getProperty("commons.log.dateformat");
    }
    ...
    public String getTimeformat() {
        return this.getProperty("commons.log.timeformat");
    }
    ...
    public String getDelimiter() {
        return this.getProperty("commons.log.delimiter");
    }
    ...
    public String getLogfolder() {
        return this.getProperty("commons.logfolder");
    }
    ...
    public int getRelaxIndex() {
        return Integer.valueOf(this.getProperty("commons.relaxindex")).intValue();
    }
     ...
     */
    public int getPort() {
        return Integer.valueOf(this.getProperty("commons.port")).intValue();
    }
    ...
    /**
     * Return the peers's bootstrap address, may be different from <i>commons's</i> bootstrap one.
     *
     * @return  the peers's bootstrap address, may be different from <i>commons's</i> bootstrap one
     */
    ...
    /**
     * Return the peers's bootstrap port, may be different from <i>commons's</i> bootstrap one.
     *
     * @return the peers's bootstrap port, may be different from <i>commons's</i> bootstrap one
     */
    ...
    /**
     * Return in millisecond the <i>commons's</i> waiting time for the synchronization.
     *
     * @return in millisecond the <i>commons's</i> waiting time for the synchronization
     */
    public int getWaitForMethod() {
        return Integer.valueOf(this.getProperty("commons.waitForMethod")).intValue();
    }
    ...
    public Level getLogLevel() {
        return Level.parse(this.getProperty("commons.log.level"));
    }
    ...
    public int getStationTreeTrace() {
        return Integer.valueOf(this.getProperty("commons.stationTreeTrace")).intValue();
    }

    /**
     * Return the value of the property that indicates the path of the file containing the commons's
     * hosts addresses.
     *
    ...
    public String getHostsFilePath() {
        ...
        return this.getProperty("commons.hostfile");
    }
    ...
    public String getCoordinationStrategyClass() {
        ...
        strategyClass = this.getProperty("fr.inria.Horda.coordinator.strategy");
        if (strategyClass == null) {
            System.out.println("Property error, using default for: fr.inria.Horda.coordinator.strategy");
            strategyClass = "fr.inria.Horda.coordinator.SequencialStrategy";
        }
