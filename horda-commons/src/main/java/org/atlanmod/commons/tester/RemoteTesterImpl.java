...
public class RemoteTesterImpl implements Tester, Serializable {
    ...
    private int id = -1;
    /**
     * The (remote) Coordinator for this commons
     */
    ...
    /**
     * Returns the coordinator for this commons. Blocks until the coordinator is
     * available.
     *
     * @return The Coordinator for this commons.
     * @throws InterruptedException
     */
    ...
    /**
     * Returns true if the current commons should quit and false for any other
     * case.
     *
